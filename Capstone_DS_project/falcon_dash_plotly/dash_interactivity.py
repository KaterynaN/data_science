...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        success_counts.columns = ['LaunchSite', 'SuccessCount']
        fig = px.pie(success_counts, values='SuccessCount',
                     names='LaunchSite',
        ...
        class_counts.columns = ['Launch Outcome', 'Count']

        fig = px.pie(class_counts, values='Count',
                     names='Launch Outcome',
                     title=f'Proportion of Successful and Failed Launches for {entered_site}',
                     labels={'Launch Outcome': 'Launch Outcome'})
    return fig
...
def get_scatter_plot(entered_site, payload_range):
    # Filter the dataframe based on the payload slider range
